...
class ParticipationRepositoryTest {
    ...
    // Déclaration des variables au niveau de la classe
    private Personne personne;
    private Projet projet1, projet2, projet3, projet4;

    @BeforeEach
    void setUp() {
        personne = new Personne("Dupont", "Michel");
    ...
    void testPersonneDeuxFoisMemeProjet() {
        ...
        try {
            ...
            // Test réussi si une exception est levée
        }
    }
    ...
    void testPersonneTroisProjet() {
        ...
        participation4.setContributeur(personne);
        participation4.setProjet(projet4);
        participation4.setRole("Manager");
        participation4.setPourcentage(10f);
